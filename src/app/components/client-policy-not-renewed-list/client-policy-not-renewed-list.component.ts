...
export class ClientPolicyNotRenewedListComponent implements OnInit {
  ...
  setPageFilters() {
    ...
    this.pageFilter.pnEffectivityDate = Utility.convertDatePickerDate(this.pageFilter.pnEffectivityDate);
    this.pageFilter.pnDueDate = Utility.convertDatePickerDate(this.pageFilter.pnDueDate);
  }
